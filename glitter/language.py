...
MESSAGES: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "settings_options": "[1] Change language  [2] Change device name  [3] Change transfer port  [4] Clear history  [5] Transfer encryption  [6] Back",
    ...
    "zh": {
        ...
        "settings_options": "[1] 更改语言  [2] 更改设备名称  [3] 更改传输端口  [4] 清空传输记录  [5] 传输加密  [6] 返回",
